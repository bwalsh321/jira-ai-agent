...
class JiraAPI:
    def __init__(self, config):
        ...
        if self.token and self.email:
            print(f"🔐 Using Basic Auth (email + token)")
    ...
    def get_all_custom_fields(self) -> Dict:
        ...
        try:
            ...
            print(f"🔍 Fetching all custom fields...")
    ...
    def check_duplicate_field(self, field_name: str) -> Dict:
        ...
        try:
            ...
            for field in all_fields["fields"]:
                ...
                elif (field_name_lower in existing_name or 
                      existing_name in field_name_lower):
                    similar.append({
                        "id": field_id,
                        "name": field.get("name", ""),
                        "type": "similar"
    ...
    def create_custom_field(self, field_name: str, field_type: str, description: str = "", options: List[str] = None) -> Dict:
    ...
    def add_field_options(self, field_id: str, options: List[str]) -> Dict:
        ...
        try:
            ...
            if config_response.status_code != 200:
                return {"error": f"Failed to get field contexts"}
